...
const COLUMNS: GridColDef<SampleRow>[] = [
  { field: "vessel",      headerName: "Vessel",      width: 120, hideable: false }, // hideable:false — Cannot be hidden
  { field: "voyage",      headerName: "Voyage",      width: 100, editable: false }, // editable:false — Can't edit even in editMode
...
export const DataGridMuiEditMode = () => {
  const [rows, setRows] = useState<SampleRow[]>(INITIAL_ROWS);

  return (
    <CardInfo title="Edit Mode Table — editMode + onRowUpdate + onRowDelete">
      <DataGridFilter
        showToolbar
        autosizeColumns
        editMode
